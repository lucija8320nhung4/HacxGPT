...
def run_about():
    ...
    about_table.add_row("What it is", "Open-source CLI for multiple AI providers; advanced system prompt engineering; connects to OpenRouter, Groq, MiniMax, HacxGPT API.")
    ...
    about_table.add_row("MiniMax", "MiniMax-M2.5 (204K), MiniMax-M2.5-highspeed (204K)")
    about_table.add_row("API keys", "OpenRouter: openrouter.ai/keys | Groq: console.groq.com/keys | MiniMax: platform.minimaxi.com | HacxGPT: hacxgpt.com")
...
def run_links():
    ...
    tbl.add_row("MiniMax (keys)", "platform.minimaxi.com")
...
def run_disclaimer():
    ...
    tbl.add_row("API usage", "Third-party providers (OpenRouter, Groq, MiniMax) have their own ToS.")
